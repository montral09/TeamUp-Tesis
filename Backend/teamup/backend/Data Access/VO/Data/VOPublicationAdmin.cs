...
namespace backend.Data_Access.VO.Data
{
    public class VOPublicationAdmin : VOPublication
    {
        ...
        public VOPublicationAdmin(int idPublication, Int64 idUser, string mail, int spaceType, string creationDate, string title, string description, string address, VOLocationCordinates location,
