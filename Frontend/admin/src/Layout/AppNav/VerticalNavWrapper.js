...
import {PaymentNav, PublNav, ResNav, GestNav, MainNav, UsrNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <MetisMenu content={ResNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
                <h5 className="app-sidebar__heading">Pagos</h5>
                <MetisMenu content={PaymentNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>   
                {/*
