                        ...
                        <Col lg="12">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <PreferentialPaymentsTable payments={this.state.payments} rejectPreferentialPayment={this.rejectPreferentialPayment} approvePreferentialPayment={this.approvePreferentialPayment}/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
