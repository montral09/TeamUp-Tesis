  ...
  return (  
    ...
    <>
      <Switch>
        ...
        <Route 
          path="/account/login"
          render={(props) => <Login {...props} userData={props.userData} updateUserLogged={props.updateUserLogged}/>}
        />
        <Route path="/account/register" component={Register} />
        <Route path="/account/forgotten" component={Forgotten} />
        ...
        <Route path="/account/add_address" component={AddAddress} />
        <Route path="/account/order" component={Order} />
        <Route path="/account/view_order" component={ViewOrder} />
        <Route path="/account/downloads" component={Downloads} />
        <Route path="/account/return" component={Return} />
