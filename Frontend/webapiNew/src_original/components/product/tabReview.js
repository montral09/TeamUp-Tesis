		...
		return (
			<React.Fragment>
				<form className="form-horizontal" id="form-review">
				    ...
				    <h3>{translate('write_a_review')}</h3>
					<div className="form-group row required">
						<div className="col-md-12">
							<label className="control-label" htmlFor="input-name">{translate('your_name')}</label>
							<input type="text" name="name" id="input-name" className="form-control" />
						</div>
					</div>
					<div className="form-group row required">
						<div className="col-md-12">
							<label className="control-label" htmlFor="input-review">{translate('your_review')}</label>
							<textarea name="text" rows="5" id="input-review" className="form-control"></textarea>
						</div>
					</div>
					<div className="form-group row required">
						<div className="col-md-12">
							<label className="control-label">{translate('rating')}</label>
							&nbsp;&nbsp;&nbsp; {translate('bad')}&nbsp;&nbsp;
					...
					<div className="buttons clearfix">
						<div className="">
							<button type="button" id="button-review" data-loading-text="Loading..." className="btn btn-primary">{translate('continue')}</button>
						</div>
					</div>
				</form>
			</React.Fragment>
