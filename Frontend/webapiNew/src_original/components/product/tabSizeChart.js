		...
		return (
			<div className="table-responsive size-chart-table">
			  <table className="table">
			    <thead>
			      <tr>
			        <td className="bold">{translate('clothing')}</td>
			        <td>XS</td>
			        <td>S</td>
			        <td>M</td>
			        <td>L</td>
			    ...
			    <tbody>
			      ...
			      <tr>
			        <th className="bold">{translate('chest_bust')} (cm)</th>
			        <td>79</td>
			        <td>79</td>
			        <td>79</td>
			        <td>79</td>
			      ...
			      <tr>
			        <th className="bold">{translate('waist')} (cm)</th>
			        <td>63</td>
			        <td>63</td>
			        <td>63</td>
			        <td>63</td>
			      ...
			      <tr>
			        <th className="bold">{translate('lower_chip')} (cm)</th>
			        <td>87</td>
			        <td>87</td>
			        <td>87</td>
			        <td>87</td>
