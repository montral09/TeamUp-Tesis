                            ...
                            <div className="container">
                                <div className="clearfix">
                                    <ul>
                                        ...
                                        <li>{translate('the_page_cannot_be_found')}!</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-12 center-column" id="content">
                                        <h1>{translate('the_page_cannot_be_found')}!</h1>
                                        <p>{translate('the_page_cannot_be_found')}.</p> 
                                        <div className="buttons">
                                            <div className="pull-right"><Link to="/" className="btn btn-primary">{translate('continue')}</Link></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
