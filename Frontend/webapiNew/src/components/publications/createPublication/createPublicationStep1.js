      ...
      return(
        <Form className="border border-light p-6">
            ...
            <FormGroup>
                ...
                <Input type="select" name="facilitiesSelect" id="facilitiesSelect" multiple onChange={this.props.onChange} defaultValue={this.props.parentState.facilitiesSelect}>
